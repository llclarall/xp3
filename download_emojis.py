...
os.chdir(r'c:\wamp64\www\xp3\images\objects')
...
for item in emoji_map:
    url = f"https://cdn.jsdelivr.net/npm/openmoji-72/color/{item['unicode']}.png"
    filename = f"{item['name']}.png"
    print(f"Downloading {item['emoji']} -> {filename}")
    try:
